...
/**
 * Child-friendly typography for Porakhela
 * Larger text sizes for better readability for kids
 */
...
val PorakhelaTypography = Typography(
    ...
    displayLarge = TextStyle(
        ...
        fontSize = 36.sp, // Larger for kids
        lineHeight = 44.sp,
        letterSpacing = 0.sp
    ),
    ...
    bodyLarge = TextStyle(
        ...
        fontSize = 16.sp, // Larger for kids
        lineHeight = 24.sp,
    ...
    labelLarge = TextStyle(
        fontFamily = FontFamily.Default,
        fontWeight = FontWeight.Medium,
        fontSize = 16.sp, // Larger for touch targets
        lineHeight = 20.sp,
        letterSpacing = 0.1.sp
    ),
